...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    axios.get("/administrator/transaksi-count").then(function (response) {
  ...
  mounted: function mounted() {
    ...
    var this2 = this; // const this3 = this

    var channel = pusher.subscribe('channel-tutofox');
    channel.bind('event-pusher', function (data) {
      //   app.messages.push(JSON.stringify(data));
      console.log(data);
      var message = this2.message; // const message1 = this3.message

      message.push(data.data); // message1.push(data.data)
    }); // Vue application
    // const app = new Vue({
    //   el: '#app',
    //   data: {
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('message-component', __webpack_require__(/*! ./components/MessageComponent.vue */ "./resources/js/components/MessageComponent.vue")["default"]);
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('message-component-count', __webpack_require__(/*! ./components/MessageComponentCount.vue */ "./resources/js/components/MessageComponentCount.vue")["default"]);
...
/***/ "./resources/js/components/MessageComponentCount.vue":
/*!***********************************************************!*\
  !*** ./resources/js/components/MessageComponentCount.vue ***!
  \***********************************************************/
/*! exports provided: default */
...
component.options.__file = "resources/js/components/MessageComponentCount.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);
