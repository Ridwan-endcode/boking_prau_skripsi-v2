                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                  @if(count($jadwals) > 0)
                                    ...
                                    @if (date('d-m-y', strtotime($jadwal->tgl_jadwal)) >=  date('d-m-y'))
                                      ...
                                      <form class="" method="post" action="{{ url('/booking-add-order-ketua') }}" enctype="multipart/form-data" > @csrf  
                                          <tr>
                                          <td>{{ date('l, j M, Y', strtotime($jadwal->tgl_jadwal)) }}</td>
                                          <td>
                                              <div class="font-14">
                                      ...
                                      <div class="col-lg-12">
                                         ...
                                         <div class="form-group">
                                          ...
                                          <div class="input-group">
                                            ...
                                            {{-- <input type="date" id="start" name="trip-start"  min="{{ date('yy-m-j', strtotime($jadwal->tgl_jadwal)) }}"> --}}

                                           <input type="date" class="form-control" name="tgl_turun" required placeholder="mm/dd/yyyy"  min="{{ date('yy-m-j', strtotime($jadwal->tgl_jadwal)) }}">
