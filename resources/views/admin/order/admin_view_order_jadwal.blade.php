                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <h4 class="page-title"> Order Pendakian pada tanggal {{ date('j M, Y', strtotime($jadwal->tgl_jadwal)) }} <br> Admin Sistem Boking Gunung Prau</h4>
...
@section('app_js')
 ...
 {{-- <script src="{{ asset('backend/pages/datatables.initpgs.js') }}"></script>    --}}
