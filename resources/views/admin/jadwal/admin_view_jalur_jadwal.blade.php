                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <h4 class="page-title">Lihat Semua Jadwal pendakian {{ $jalur_pendakian->nama_jalur }} <br> Sistem Boking Gunung Prau</h4>
                                ...
                                <div class="col-sm-6">
                                    <ol class="breadcrumb float-right">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ url('/administrator/view-jalurpendakian') }}">Lihat Jalur</a></li>
                                        <li class="breadcrumb-item active">Lihat Jadwal Jalur</li>
                                    </ol>
                                </div>
                            </div>
                            <!-- end row -->
